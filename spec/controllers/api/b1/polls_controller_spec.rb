...
describe API::B1::PollsController do
  ...
  describe 'create' do
    it 'happy case' do
      ...
      post :create, params: { title: 'test', poll_type: 'proposal', closing_at: 3.days.from_now.iso8601, recipient_audience: 'group', options: ['agree', 'disagree'], api_key: webhook.token }
